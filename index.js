...
var VIEWPAGER_REF = 'multiViewPager';
...
class MultiViewPager extends Component {
  ...
  setPage = (selectedPage: number) => {
    UIManager.dispatchViewManagerCommand(
      ...
      UIManager.ReactMultiViewPager.Commands.setPage,
      [selectedPage],
    );
  };
  ...
  setPageWithoutAnimation = (selectedPage: number) => {
    UIManager.dispatchViewManagerCommand(
      ReactNative.findNodeHandle(this),
      UIManager.ReactMultiViewPager.Commands.setPageWithoutAnimation,
      [selectedPage],
    );
  };
...
const ReactMultiViewPager = requireNativeComponent("ReactMultiViewPager", MultiViewPager);
